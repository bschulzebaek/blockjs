...
import generationV1 from '@/framework/world/generation/v1';
import generationV2 from '@/framework/world/generation/v2';
import generationV3 from '@/framework/world/generation/v3';
